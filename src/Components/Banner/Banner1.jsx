      ...
      <div className="container mx-auto space-y-5 text-center lg:text-left z-10 relative flex justify-center items-center pt-20 pb-10">
        <div>
          ...
          <p className="text-black font-medium">
            Immerse Yourself in a Symphony of Innovation, Where Every Pixel
            Tells a Tale, Every Click Chronicles Progress, and Every Product
            Embodies Excellence. Welcome to a World Where Technology and
            Elegance Converge.
          </p>
          <Link
            to={"/register"}
            className="btn bg-[#eb347a] hover:bg-[#ff6e96] py-2 px-6 rounded-full inline-block mt-4 transition duration-300"
          >
            Register Now
          </Link>
        </div>
        <img
          ...
          className="hidden lg:block mt-8 mx-auto max-w-[400px] rounded-md shadow-lg"
        />
      </div>
